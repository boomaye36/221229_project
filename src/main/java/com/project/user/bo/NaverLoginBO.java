...
import com.project.util.NaverLoginApi;
@Service
...
//    private final static String CLIENT_ID = "HWYnGH9P3uPQNouoAvyz";       //네이버API Client ID
//    private final static String CLIENT_SECRET = "p5PxnzHE5w";                      
//    private final static String REDIRECT_URI = "http://localhost/users/callback.do";
...
//    }
//
	private final static String CLIENT_ID = "HWYnGH9P3uPQNouoAvyz";
	   private final static String CLIENT_SECRET = "p5PxnzHE5w";
	   private final static String REDIRECT_URI = "http://localhost/users/callback.do";
	   private final static String SESSION_STATE = "oauth_state";
